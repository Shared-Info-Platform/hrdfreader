...
COMMENT ON COLUMN HRDF_FPLANFahrt_TAB.cyclecount is 'Taktanzahl der noch folgenden Takte';
COMMENT ON COLUMN HRDF_FPLANFahrt_TAB.cycletime is 'Taktzeit in Minuten (Abstand zwiscehn zwei Fahrten)';
